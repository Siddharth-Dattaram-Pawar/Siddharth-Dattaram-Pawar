...
| [Data Warehousing with AWS and DBT](https://github.com/Siddharth-Dattaram-Pawar/Data_Warehousing_with_AWS_and_DBT)  | Designed a star schema data warehouse using 4 fact and 10+ dimension tables in DBeaver ; Built an automated ETL pipeline by configuring security groups, VPCs and subnets with Redshift and AWS Glue  sourcing raw data from S3 ; Transformed data and validated the model with DBT to structure data as per Medallion Architecture ; Implemented documentation and data quality tests using DBT to ensure model integrity and consistency.|
